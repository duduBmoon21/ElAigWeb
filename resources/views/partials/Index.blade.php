    ...
    @else
        ...
        <li  class="nav-item dropdown">
                @if($section->name == 'Home')
                    <a class="nav-link" href="{{ route('home') }}">{{ $section->name }}</a>
                @elseif($section->name == 'About')
                    <a class="nav-link" href="#" id="aboutDropdown" data-bs-toggle="dropdown" aria-expanded="false">{{ $section->name }}</a>
                ...
                @elseif($section->name == 'Services')
                    <a class="nav-link" href="#" id="servicesDropdown" data-bs-toggle="dropdown" aria-expanded="false">{{ $section->name }}</a>
                ...
                @elseif($section->name == 'Pricing')
                    <a class="nav-link" href="{{ route('pricing') }}">{{ $section->name }}</a>
                @elseif($section->name == 'Contact')
                    <a class="nav-link" href="{{ route('contact') }}">{{ $section->name }}</a>
                @endif
            </li>
        @endforeach
    @endif
